...
def load_tag_nums():
    """tag_num.json에서 태그 번호(1~10)를 로드합니다."""
    cfg_path = os.path.join(os.path.dirname(__file__), 'tag_num.json')
    try:
        ...
        print("⚠️ tag_num.json not found. Using empty tag list.")
        return {}
    except Exception as e:
        print(f"⚠️ Failed to load tag_num.json: {e}")
        return {}
